...
function() {
  ...
  */
  //-- start custom: add callback argument
  ...
  //-- end custom
    ...
    //-- start custom: add callback handler
    if (callback) {
      callback(block);
    }
    //-- end custom
  ...
  */
  //-- start custom: wrap initHighlighting to pass callback
  function initHighlighting(callback) {
    ...
    Array.prototype.forEach.call(blocks, function(code){highlightBlock(code, callback)});
  }
  //-- end custom
